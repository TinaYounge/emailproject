const languageReplies = {
    "vn": {
        ...
        `,
        "missingKatakana": `
            <div class="sentence">Quý khách chưa nhập tên Katakana. Tên Katakana của quý khách sẽ dùng để viết trên thẻ rút tiền của quý khách. 
            </div>
        `,
        "no": `
            <p>
        ...
        `,
        "scanID": `
        <p class="indented-text dot">Ảnh thẻ cư trú đã cung cấp không đủ rõ ràng.</p>
    `,
        "general": `
            <h2>Dear {name},</h2>
